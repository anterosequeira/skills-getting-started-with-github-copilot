...
activities = {
    ...
    "Basketball Team": {
        "description": "Join the team for practice and interschool games",
        "schedule": "Mondays, Wednesdays, 4:00 PM - 6:00 PM",
        "max_participants": 18,
        "participants": ["liam@mergington.edu", "ava@mergington.edu"]
    },
    "Soccer Club": {
        "description": "Play soccer and improve skills through drills and scrimmages",
    ...
    "Debate Team": {
        "description": "Build persuasive speaking and critical thinking skills",
